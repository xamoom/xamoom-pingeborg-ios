...
@implementation XMMContentList

+ (RKResponseDescriptor*)contentDescriptor {
  RKObjectMapping* responseMapping = [RKObjectMapping mappingForClass:[XMMContentList class]];
  [responseMapping addAttributeMappingsFromDictionary:@{@"cursor":@"cursor",
                                                        @"more":@"hasMore",
                                                        }];
  RKObjectMapping* responseItemMapping = [XMMContent mapping];
