...
/**
 `XMMResponseStyle` is used for mapping the JSON sended by the api.
 */
@interface XMMResponseStyle : NSObject
...
/**
 Returns a RKObjectMapping for `XMMResponseStyle` class.
